...
import { updateMode } from "../state/modeSlice";
...
export default function AppBarComponent() {
  ...
  return (
    <Box width="100vw" position="fixed" top={0} zIndex={2} height="50px">
      <Box
        position="static"
        sx={{
          bgcolor:
      ...
      >
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center", height: "50px" }}>
            <IconButton aria-label="menu" onClick={handleToggleMenu}>
              <img src={logo} alt="menu" width={"35px"} height={"35px"} />
            </IconButton>
